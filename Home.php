			...
			<!-- Carousel -->
				...
				<section class="carousel">
					<div class="reel">
						...
						<article>
							<a href="Book.php#availability" class="image featured"><img src="images/IHop Gray logo.png" style ="max-width:230px; text-align:center;" alt="Island Hoppin' Availability" /></a>
							<header>
