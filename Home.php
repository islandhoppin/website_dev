			...
			<!-- Carousel -->
				...
				<section class="carousel">
					<div class="reel">
						...
						<article>
							<a href="Book.php#availability" class="image featured"><img src="images/IHop Gray logo.png" style ="max-height:250px; max-width:130px;" alt="Island Hoppin' Availability" /></a>
							<header>
